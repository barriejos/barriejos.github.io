...
- **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to barriejos.
...
- **Website** refers to barriejos, accessible from [http://localhost:4321/](http://localhost:4321/)
